...
def calculate_dist_from_goals(bbox, homography):
    position = calculate_radar_position(bbox, homography)
    return np.min(np.linalg.norm(GOAL_CENTERS - position, axis=1))
